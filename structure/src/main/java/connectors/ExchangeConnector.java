...
public class ExchangeConnector extends OAuthConnector{
	...
	public ExchangeConnector connect(String username){
		String authParams = "resource="+resource+"&client_id="+clientId+"&response_type=code&redirect_uri="+getRedirectUri()+"&login_hint="+username;
		String tokenParams = "grant_type=authorization_code&code={code}&client_id="+clientId+"&resource="+resource+"&redirect_uri="+getRedirectUri();
